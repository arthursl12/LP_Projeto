...
\\000"
 ...
 (1, 
"\003\003\003\003\003\003\003\003\003\013\015\003\003\003\003\003\
\\003\003\003\003\003\003\003\003\003\003\003\003\003\003\003\003\
\\013\003\003\003\003\003\003\003\012\011\003\003\010\003\003\003\
...
{fin = [], trans = 1},
{fin = [(N 22)], trans = 0},
{fin = [(N 7),(N 22)], trans = 4},
{fin = [(N 7)], trans = 4},
{fin = [(N 18),(N 22)], trans = 0},
{fin = [(N 16),(N 22)], trans = 0},
{fin = [(N 10),(N 22)], trans = 8},
{fin = [(N 10)], trans = 8},
{fin = [(N 20),(N 22)], trans = 0},
{fin = [(N 14),(N 22)], trans = 0},
{fin = [(N 12),(N 22)], trans = 0},
{fin = [(N 4),(N 22)], trans = 13},
{fin = [(N 4)], trans = 13},
{fin = [(N 1)], trans = 0}])
end
