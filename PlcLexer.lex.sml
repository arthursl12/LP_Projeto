...
\\023\021\003\003\003\003\003\003\020\019\018\017\016\014\003\013\
\\011\011\011\011\011\011\011\011\011\011\003\003\009\008\003\003\
...
{fin = [], trans = 1},
{fin = [(N 43)], trans = 0},
{fin = [(N 7),(N 43)], trans = 4},
{fin = [(N 7)], trans = 4},
{fin = [(N 18),(N 43)], trans = 0},
{fin = [(N 16),(N 43)], trans = 0},
{fin = [(N 33),(N 43)], trans = 0},
{fin = [(N 38),(N 43)], trans = 9},
{fin = [(N 41)], trans = 0},
{fin = [(N 10),(N 43)], trans = 11},
{fin = [(N 10)], trans = 11},
{fin = [(N 31),(N 43)], trans = 0},
{fin = [(N 27),(N 43)], trans = 14},
{fin = [(N 23)], trans = 0},
{fin = [(N 20),(N 43)], trans = 0},
{fin = [(N 25),(N 43)], trans = 0},
{fin = [(N 29),(N 43)], trans = 0},
{fin = [(N 14),(N 43)], trans = 0},
{fin = [(N 12),(N 43)], trans = 0},
{fin = [(N 43)], trans = 21},
{fin = [(N 36)], trans = 0},
{fin = [(N 4),(N 43)], trans = 23},
{fin = [(N 4)], trans = 23},
{fin = [(N 1)], trans = 0}])
end
