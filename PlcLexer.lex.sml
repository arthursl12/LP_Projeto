...
\\015\003\003\003\003\003\003\003\014\013\003\003\012\010\003\003\
...
{fin = [], trans = 1},
{fin = [(N 25)], trans = 0},
{fin = [(N 7),(N 25)], trans = 4},
{fin = [(N 7)], trans = 4},
{fin = [(N 18),(N 25)], trans = 0},
{fin = [(N 16),(N 25)], trans = 0},
{fin = [(N 10),(N 25)], trans = 8},
{fin = [(N 10)], trans = 8},
{fin = [(N 25)], trans = 10},
{fin = [(N 23)], trans = 0},
{fin = [(N 20),(N 25)], trans = 0},
{fin = [(N 14),(N 25)], trans = 0},
{fin = [(N 12),(N 25)], trans = 0},
{fin = [(N 4),(N 25)], trans = 15},
{fin = [(N 4)], trans = 15},
{fin = [(N 1)], trans = 0}])
end
