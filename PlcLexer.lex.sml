...
\\000"
 ...
 (1, 
"\003\003\003\003\003\003\003\003\003\011\013\003\003\003\003\003\
\\003\003\003\003\003\003\003\003\003\003\003\003\003\003\003\003\
\\011\003\003\003\003\003\003\003\010\009\003\003\008\003\003\003\
...
{fin = [], trans = 1},
{fin = [(N 18)], trans = 0},
{fin = [(N 7),(N 18)], trans = 4},
{fin = [(N 7)], trans = 4},
{fin = [(N 10),(N 18)], trans = 6},
{fin = [(N 10)], trans = 6},
{fin = [(N 16),(N 18)], trans = 0},
{fin = [(N 14),(N 18)], trans = 0},
{fin = [(N 12),(N 18)], trans = 0},
{fin = [(N 4),(N 18)], trans = 11},
{fin = [(N 4)], trans = 11},
{fin = [(N 1)], trans = 0}])
end
...
| 12 => (LPAR(yypos, yypos))
| 14 => (RPAR(yypos, yypos))
| 16 => (COMMA(yypos, yypos))
| 18 => let val yytext=yymktext() in error("\n***lexer error: bad character ***\n"); raise Fail("Lexer error:"^
