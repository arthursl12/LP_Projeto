...
\\000"
 ...
 (1, 
"\003\003\003\003\003\003\003\003\003\028\030\003\003\003\003\003\
\\003\003\003\003\003\003\003\003\003\003\003\003\003\003\003\003\
\\028\026\003\003\003\003\024\003\023\022\021\020\019\017\003\016\
...
{fin = [], trans = 1},
{fin = [(N 51)], trans = 0},
{fin = [(N 7),(N 51)], trans = 4},
{fin = [(N 7)], trans = 4},
{fin = [(N 18),(N 51)], trans = 0},
{fin = [(N 16),(N 51)], trans = 0},
{fin = [(N 33),(N 51)], trans = 0},
{fin = [(N 38),(N 51)], trans = 9},
{fin = [(N 41)], trans = 0},
{fin = [(N 46),(N 51)], trans = 0},
{fin = [(N 51)], trans = 12},
{fin = [(N 44)], trans = 0},
{fin = [(N 10),(N 51)], trans = 14},
{fin = [(N 10)], trans = 14},
{fin = [(N 31),(N 51)], trans = 0},
{fin = [(N 27),(N 51)], trans = 17},
{fin = [(N 23)], trans = 0},
{fin = [(N 20),(N 51)], trans = 0},
{fin = [(N 25),(N 51)], trans = 0},
{fin = [(N 29),(N 51)], trans = 0},
{fin = [(N 14),(N 51)], trans = 0},
{fin = [(N 12),(N 51)], trans = 0},
{fin = [(N 51)], trans = 24},
{fin = [(N 49)], trans = 0},
{fin = [(N 51)], trans = 26},
{fin = [(N 36)], trans = 0},
{fin = [(N 4),(N 51)], trans = 28},
{fin = [(N 4)], trans = 28},
{fin = [(N 1)], trans = 0}])
end
...
| 4 => (lex())
| 41 => (LTE(yypos, yypos))
| 44 => (DCOLON(yypos, yypos))
| 46 => (SEMIC(yypos, yypos))
| 49 => (AND(yypos, yypos))
| 51 => let val yytext=yymktext() in error("\n***lexer error: bad character ***\n"); raise Fail("Lexer error:"^
